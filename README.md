...
- **Strona (Vercel):** https://heroes3-new-design.vercel.app
...
Albo wejdź na https://heroes3-new-design.vercel.app. Działa offline (ścieżki względne, dane w `js/mods-data.js`).
